...
for (i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    ...
    case "brown":
      ...
      break
    case "yellow":
      eyeColor.red[i].push(starWarsCharacters[i])
      break
    case "Blue-gray":
      eyeColor.blueGrey[i].push(starWarsCharacters[i])
      break
  }
}
...
while (counter < starWarsCharacters.length) {
  totalMass = totalMass + starWarsCharacters[counter].mass
  counter++
}
...
if (totalMass <= 500) {
  ...
  console.log("Warning: Load is over 900")
} else {
